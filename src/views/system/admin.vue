<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="最后一次登陆时间" prop="lastLoginTime"/>
      <el-table-column align="center" label="最后一次登陆IP" prop="lastLoginIp"/>

      <el-table-column align="center" label="管理员角色" prop="roleList">
        <template slot-scope="scope">
          <el-tag v-for="role in scope.row.roleList" :key="role" style="margin-right: 20px;"> {{ role }} </el-tag>
        </template>
      </el-table-column>
